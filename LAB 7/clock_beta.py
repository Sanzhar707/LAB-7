...
while not done:
    ...
    myCircle = pygame.draw.circle(screen, 'Black', (300, 300), 170)
    centre = pygame.draw.circle(screen, 'Red', (300, 300), 20)

    pygame.draw.line(screen, 'Red', (300, 300), (300 + 200 * math.sin(math.radians(angle)), 300 - 200 * math.cos(math.radians(angle))), 10)
    pygame.draw.line(screen, 'Red', (300, 300), (300 + 130 * math.sin(math.radians(gradus)), 300 - 130 * math.cos(math.radians(gradus))), 10)
